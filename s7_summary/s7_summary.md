...
## 21. コンペ最終枠 (Slot 5) の提出ロードマップ

- **コンペ終了時刻**: 2026-09-24 09:00 JST (09:00 JST までに Scoring 中になっていれば公式集計対象)
- **提出目標時刻**: 2026-09-24 08:00 JST まで
- **提出枠残数**: **残り 1 枠 (Slot 5)**
- **推奨アクション**:
  - **安定重視 (0.948 の絶対維持・堅守)**: **候補 A (`s7-041a-pure-sota-ipynb`)** を提出
  - **攻め重視 (0.948 超え・GT スコア向上モデル)**: **候補 B (`s7-041b-density-adaptive-ipynb`)** を提出
